...
export async function createFriendRequestHandler(req, res) {
  try {
    ...
    //Kiem tra loi gui ket ban co hay chua
...
//Tao thong bao khi gui loi moi ket ban
  ...
  //Luu thong bao va tra ve client
